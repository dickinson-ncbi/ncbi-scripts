...
# example usage
# python prune-gaps.pl <pfram.stk file> <gap 5' end tolerance> <gap 3' end tolerance> 

# -list option
# ex. python prune-gaps.pl <pfram.stk file> -list <output.txt> <gap 5' end tolerance> <gap 3' end tolerance> 
